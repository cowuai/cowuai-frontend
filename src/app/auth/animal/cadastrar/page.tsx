...
const formSchema = z.object({
    ...
    sexo: z.enum([SexoAnimal.MACHO, SexoAnimal.FEMEA], {
...
export default function CadastrarAnimalPage() {
    ...
    useEffect(() => {
        ...
        const carregarFazendas = async () => {
            ...
            try {
                const resF = await getFazendasByIdProprietario(
        ...
        const carregarAnimais = async () => {
            ...
            try {
                const res = await getAnimalsByIdProprietario(
                    accessToken,
                    String(usuarioAtivo.id)
                );
        ...
        try {
            ...
            const payload = {
                ...
                dataNascimento: values.dataNascimento
                    ...
                    : null,
                numeroParticularProprietario:
                    values.numeroParticularProprietario || null,
            ...
            handleUiError(err, { defaultMessage: "Erro ao salvar cadastro." });
        } finally {
            setIsLoading(false);
        }
    }
    ...
    return (
        <div className="max-w-7xl mx-auto py-8 px-4">
            ...
            <div className="mb-8">
                <Link
                    href="/auth/animal/listar"
                    className="inline-flex items-center text-sm text-muted-foreground hover:text-foreground mb-4"
                >
                    <ArrowLeft className="mr-2 h-4 w-4"/>
                    Voltar para animais
                </Link>
                {/* Aqui ajustei a cor do titulo para usar o padrão vermelho se nao for tema escuro, ou branco se for escuro, ou manter primary */}
                <h1 className="text-3xl text-red-900 dark:text-white font-tsukimi-rounded mb-2">
                    Cadastrar Animal
                </h1>
                <BreadcrumbArea/>
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                                ...
                                <FormField
                                    ...
                                    render={({field}) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input
                                                    placeholder="Número do proprietário"
                                                    {...field}
                                                />
                                            </FormControl>
                                            <FormMessage/>
                        ...
                        <div className="flex gap-4 justify-end pt-4">
                            ...
                            <Button
                                type="submit"
                                disabled={isLoading}
                                className="bg-red-900 text-white hover:bg-red-800 dark:bg-red-900 dark:text-white dark:hover:bg-red-800"
                            >
