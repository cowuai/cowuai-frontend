...
export const EditAnimalModal: React.FC<EditAnimalModalProps> = ({
  ...
  const animaisMachos = useMemo(
    () =>
      animaisProprietario.filter(
        (a) => a.sexo === SexoAnimal.MACHO && a.id !== formData?.id
      ),
  ...
  const animaisFemeas = useMemo(
    () =>
      animaisProprietario.filter(
        (a) => a.sexo === SexoAnimal.FEMEA && a.id !== formData?.id
      ),
    [animaisProprietario, formData?.id]
  );
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex flex-col gap-1">
                ...
                <Select
                  ...
                  onValueChange={(val) =>
                    handleChange("idMae", val ? Number(val) : null)
                  }
                >
                  <SelectTrigger className="w-full border-red-900/20">
              ...
              <div className="flex flex-col gap-1">
                ...
                <Select
                  ...
                  onValueChange={(val) =>
                    handleChange("idPai", val ? Number(val) : null)
                  }
                >
                  <SelectTrigger className="w-full border-red-900/20">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-1">
                ...
                <Select
                  ...
                  onValueChange={(val) =>
                    handleChange("idFazenda", Number(val))
                  }
                >
                  <SelectTrigger className="w-full border-red-900/20">
