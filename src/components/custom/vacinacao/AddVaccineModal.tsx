...
export default function AddVaccineModal({idAnimal, sexoAnimal, onSaved}: Props) {
    ...
    const onSubmit = async (data: FormValues) => {
        ...
        try {
            ...
            handleUiError(err, {defaultMessage: "Erro ao salvar vacina."});
        }
    };
                                    ...
                                    <Popover>
                                        <PopoverTrigger asChild>
                                            <FormControl>
                                                ...
                                                >
                                                    {field.value ? (format(new Date(field.value + "T00:00:00"), "dd/MM/yyyy")) : (
                                ...
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input disabled placeholder="Calculada automaticamente"
                                               value={field.value ? format(new Date(field.value + "T00:00:00"), "dd/MM/yyyy") : ""}
                                               readOnly/>
                                    </FormControl>
                                    <FormMessage/>
                                </FormItem>
                                ...
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input placeholder="Digite o lote da vacina" {...field}
                                               value={field.value ?? ''} disabled={allowedVacinas.length === 0}/>
                                    </FormControl>
                                    <FormMessage/>
                                </FormItem>
                            )}
